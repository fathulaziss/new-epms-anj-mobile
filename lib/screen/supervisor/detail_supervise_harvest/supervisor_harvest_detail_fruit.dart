...
class SuperviseHarvestDetailFruit extends StatefulWidget {
  ...
  @override
  State<SuperviseHarvestDetailFruit> createState() =>
      _SuperviseHarvestDetailFruitState();
}

class _SuperviseHarvestDetailFruitState
    extends State<SuperviseHarvestDetailFruit> {
  @override
        ...
        child: Padding(
          ...
          child: Column(children: [
                ...
                TableRow(
                  children: <Widget>[
                    Container(
                      width: 110,
                      child: Column(children: [
                        Text("${notifier.ophSupervise?.bunchesRipe ?? 0}",
            ...
            Column(children: [
              ...
              SizedBox(height: 20),
              Text(
                  "${notifier.ophSupervise?.supervisiNotes ?? "Tidak ada catatan"}")
            ]),
          ]),
        ),
      );
