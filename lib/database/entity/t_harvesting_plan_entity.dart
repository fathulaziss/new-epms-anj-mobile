class THarvestingPlanEntity {
  static String harvestingPlanId = "harvesting_plan_id";
  static String harvestingPlanDate = "harvesting_plan_date";
  static String harvestingPlanEstateCode = "harvesting_plan_estate_code";
  static String harvestingPlanDivisionCode = "harvesting_plan_division_code";
