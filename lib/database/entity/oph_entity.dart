class OPHEntity {
  ...
  static String ophPlantCode = 'oph_plant_code';
  ...
  static String ophLat = 'oph_lat';
  static String ophLong = 'oph_long';
  static String ophPhoto = 'oph_photo';
  static String mandor1EmployeeCode = 'mandor1_employee_code';
  static String mandor1EmployeeName = 'mandor1_employee_name';
  static String keraniKirimEmployeeCode = 'kerani_kirim_employee_code';
  static String keraniKirimEmployeeName = 'kerani_kirim_employee_name';
  ...
  static String ophApprovedBy = 'oph_approved_by';
  static String ophApprovedByName = 'oph_approved_by_name';
  static String ophApprovedDate = 'oph_approved_date';
  static String ophApprovedTime = 'oph_approved_time';
