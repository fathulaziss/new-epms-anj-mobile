class TWorkPlanSchemaEntity {
  ...
  static String workplanDivisionCode = "workplan_division_code";
  static String workplanActivityCode = "workplan_activity_code";
  static String workplanActivityName = "workplan_activity_name";
  static String workplanActivityUom = "workplan_activity_uom";
  ...
  static String workplanCostCenter = "workplan_cost_center";
  static String isApproved = "is_approved";
  static String workplanApprovedBy = "workplan_approved_by";
  static String workplanApprovedByName = "workplan_approved_by_name";
  static String workplanApprovedDate = "workplan_approved_date";
  static String workplanApprovedTime = "workplan_approved_time";
