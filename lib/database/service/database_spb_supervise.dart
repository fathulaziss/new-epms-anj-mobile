...
class DatabaseSPBSupervise {
  void createTableSPB(Database db) async {
    await db.execute('''
      ...
      ${SPBSuperviseEntity.supervisiSpbPhoto1} TEXT,
      ${SPBSuperviseEntity.supervisiSpbPhoto2} TEXT,
      ...
      ${SPBSuperviseEntity.unripeParteno} INT,
      ${SPBSuperviseEntity.unripeBroken} INT,
      ${SPBSuperviseEntity.unripeRat} INT,
      ${SPBSuperviseEntity.unripeRotten} INT,
      ${SPBSuperviseEntity.unripeOther} INT,
      ${SPBSuperviseEntity.unripeAbnornmalTotal} INT,

      ${SPBSuperviseEntity.halfripeParteno} INT,
      ${SPBSuperviseEntity.halfripeBroken} INT,
      ${SPBSuperviseEntity.halfripeRat} INT,
      ${SPBSuperviseEntity.halfripeRotten} INT,
      ${SPBSuperviseEntity.halfripeOther} INT,
      ${SPBSuperviseEntity.halfripeAbnormalTotal} INT,

      ${SPBSuperviseEntity.ripeParteno} INT,
      ${SPBSuperviseEntity.ripeBroken} INT,
      ${SPBSuperviseEntity.ripeRat} INT,
      ${SPBSuperviseEntity.ripeRotten} INT,
      ${SPBSuperviseEntity.ripeOther} INT,
      ${SPBSuperviseEntity.ripeAbnormalTotal} INT,

      ${SPBSuperviseEntity.overripeParteno} INT,
      ${SPBSuperviseEntity.overripeBroken} INT,
      ${SPBSuperviseEntity.overripeRat} INT,
      ${SPBSuperviseEntity.overripeRotten} INT,
      ${SPBSuperviseEntity.overripeOther} INT,
      ${SPBSuperviseEntity.overripeAbnormalTotal} INT,

      ${SPBSuperviseEntity.emptyParteno} INT,
      ${SPBSuperviseEntity.emptyBroken} INT,
      ${SPBSuperviseEntity.emptyRat} INT,
      ${SPBSuperviseEntity.emptyRotten} INT,
      ${SPBSuperviseEntity.emptyOther} INT,
      ${SPBSuperviseEntity.emptyAbnormalTotal} INT,
